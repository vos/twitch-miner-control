...
/**
 * The category a channel is streaming under, below the streamer's name.
 *
 ...
 * subtitle rather than as another status chip. The viewer count is a
 * sibling cell rather than part of this line -- see ViewerCount.
 *
 ...
 * unreachable.
 */
export function StreamContext({ game, title }: Props) {
  ...
  const line = <span className={classes.game}>{game}</span>;
